  ...
  return (
    <div>
      ...
      <div className="m-0 p-0">
        {/*Section#1 */}
        <div className="bg-gray-700 flex flex-col items-center space-y-2 border-2 lg:space-x-4 py-24">
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center gap-2 lg:overflow-hidden overflow-scroll scrollbar-hide m-4">
            <div className="min-w-max max-w-max overscroll-x-auto">
              <Image
                src="/dummylogo.jpeg"
                alt="dummy logo"
                height="75"
        ...
        <div className="bg-gray-700 my-12">
          <Career />
        </div>
        <div className="px-4">
        ...
        <div className="p-4 px-8">
          <p className="text-3xl text-black font-bold my-4">
